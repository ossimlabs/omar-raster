...
class OmarRasterPluginGrailsPlugin extends Plugin {
   ...
   // URL to the plugin's documentation
       def documentation = "https://grails.github.io/OmarRasterPlugin/"
   ...
   //    def issueManagement = [ system: "GitHub", url: "https://github.com/grails/OmarRasterPlugin/issues" ]

       // Online location of the plugin's browseable source code.
   //    def scm = [ url: "https://github.com/grails/OmarRasterPlugin" ]
